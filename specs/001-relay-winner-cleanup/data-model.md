...
- winner_reason: string? (TeamElimination | ObjectiveDetonated | ObjectiveDefused | TimeExpiration)
...
### WinnerReason
- authority: TeamElimination | ObjectiveDetonated | ObjectiveDefused | TimeExpiration
- source_detail: string (optional debug note such as "no plant at 180s")
...
- Host-supplied winners are ignored; only objective/time/elimination outcomes are honored.
